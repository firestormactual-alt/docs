...
<AccordionGroup>
  <Accordion title="FH/PB-28 - Code of Conduct" icon="gavel" iconType="solid">
  ...
  <Accordion title="FH/PB-29 - Respectful Conduct" icon="gavel" iconType="solid">
  ...
  <Accordion title="FH/PB-30 - Conduct during Operations" icon="gavel" iconType="solid">
  ...
  <Accordion title="FH/PB-31 - Representing Hightower" icon="gavel" iconType="solid">
    As a member of Task Force Hightower, your actions and behavior represent our entire organization. As such, you are to maintain respect at all times. Grave offenses without direct representation may result in punitive action. Actions may also be taken if disrespectful behavior:
