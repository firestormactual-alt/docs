  ...
  <Accordion title="FH/G06 - Code of Conduct" defaultOpen>
    <AccordionGroup>
      ...
      <Accordion title="FH/PB-32 - Article 5: Information Security" icon="gavel" iconType="solid">
        ...
        3. Record any conversation where privacy is reasonably expected; or
      ...
      <Accordion title="FH/PB-33 - Code of Conduct Violations" icon="gavel" iconType="solid">
        The Code of Conduct is a vital part of Task Force Hightower's culture and belief. As such, violations of the Code, Hightower's rules, and the Hightower UCMJ [**_LINK_**] are investigated and punished with gravity. Once a violation is detected or reported, an investigation will be opened by Task Force Command's J1 and J2 shops. If substantiated, a reprimand will be issued. These may include the following:

        1. Verbal Counseling
        2. Timeouts
        3. Strikes 3. Demotion 4. Combat Role Limitation 5. Suspension 6. Discharge 7. Temporary Ban 8. Permanent Ban/Blacklist

        Punishments may be issued by UNICOM+, but may be requested by all levels of leadership. They are sourced from one of three methods:

        1. Non-Judicial Punishment - Used for moderate rule violations that do not warrant permanent removal. NJPs (also known as Article 15s) may issue any punishment not including Discharge or Bans. They may be challenged by a Court Martial.
        2. Court Martial - Used for major rule violations or when other options are exhausted. Court Martials may determine to impose any punishment listed here, and are used to validate Executive Punishments and NJPs when challenged. Court Martial decisions are final.
        3. Executive Punishment - May only be issued by TASCOM+ and**_must be signed by the TFCO prior  to implementation_**. Executive Punishments may include any punishment, but may be challenged by a Court Martial. This includes cases of Bans for a period of up to 14 days after issuance.
      </Accordion>
    </AccordionGroup>
    <Warning>
      **FH/PB-33 is incomplete. Include HUCMJ when created.**
    </Warning>
  </Accordion>
</AccordionGroup>