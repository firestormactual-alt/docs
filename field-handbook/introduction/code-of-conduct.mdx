...
<AccordionGroup>
  <Accordion title="FH/G06 - Code of Conduct" defaultOpen={false}>
    <AccordionGroup>
      ...
      <Accordion title="FH/PB-33 - Code of Conduct Violations" icon="gavel" iconType="solid">
        ...
        3. Strikes
           3. Demotion
           4. Combat Role Limitation
           5. Suspension
           6. Discharge
           7. Temporary Ban
           8. Permanent Ban/Blacklist
        ...
        3. Executive Punishment - May only be issued by TASCOM+ and**must be signed by the TFCO _prior_  to implementation**. Executive Punishments may include any punishment, but may be challenged by a Court Martial. This includes cases of Bans for a period of up to 14 days after issuance.
      </Accordion>
    </AccordionGroup>
    <Warning>
      **FH/PB-33 is incomplete.**
    </Warning>
  </Accordion>
</AccordionGroup>