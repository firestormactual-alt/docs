  ...
  <Accordion title="FH/G02 - Getting Started" defaultOpen>
    <AccordionGroup>
      ...
      <Accordion title="FH/GB-11 - Enlistment/Commissioning" icon="book" iconType="solid">
        Joining Task Force Hightower is a simple but sophisticated process to ensure our members are capable and competent. The current admission process includes  applications, Initial Entry Training, and application for a clearance depending on your position.
        ...
        **Clearance Application:** Certain positions may require you to fill out a HSF-86 in the Task Force Hightower SecureNet to apply for a security clearance. Clearances help protect proprietary information and procedures from being used against Hightower, whether as theft of intellectual property or in combat.
      </Accordion>
    </AccordionGroup>
  </Accordion>
</AccordionGroup>