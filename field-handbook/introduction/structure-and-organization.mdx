...
<AccordionGroup>
  <Accordion title="FH/PB-44 - Task Force Command (TASCOM)" icon="gavel" iconType="solid">
    ...
    - Unit Commanders (COs)
      - Role: COs provide representation from each component of Hightower to TASCOM. They act as the highest ranking officials in each unit, and form the core of the TASCOM structure.
      - Authority: The COs act as the highest leadership for each unit and oversee their unit's training, standards, and personnel matters. They have ultimate authority for their given unit, second only to the TFCO and TFXO.
      - Position: A CO is typically a Captain or a Major.
    - Former Unit Commanders (Former COs)
      - Role: Former COs provide valuable guidance on unit operations from previous experience, and maintain a critical role in the shaping of the faction.
      - Authority: Former COs have no authority other than that granted by their current rank and position, but may advise on any decision applicable to their knowledge.
      - Position: Former COs may hold any rank.
  </Accordion>
