...
<AccordionGroup>
  <Accordion title="FH/PB-44 - Task Force Command (TASCOM)" icon="gavel" iconType="solid">
    ...
    - Unit Commanders (COs)
      - Role: Unit Commanders provide representation from each component of Hightower to TASCOM. They act as the highest ranking officials in each unit, and form the core of the TASCOM structure.
      - Authority: 
